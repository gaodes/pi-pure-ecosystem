...
export function renderPanelTitleLine(title: string, width: number, theme: Theme): string {
	...
	return dim("─".repeat(leftBorder)) + accent(bold(titleText)) + dim("─".repeat(rightBorder));
}
